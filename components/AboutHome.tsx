...
export default function AboutHome() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // UPDATED: Triggers "restart" every time it enters the viewport
      gsap.fromTo(`.${styles.revealElement}`, 
        ...
        },
        {
          ...
          ease: "power4.out", 
          scrollTrigger: {
            trigger: sectionRef.current, // Use sectionRef for a stable trigger point
            start: "top 75%",            // Triggers when scrolling down into it
            end: "bottom 20%",           // Triggers when scrolling up into it
            // play | reverse (on leave) | restart (on scroll back up) | reverse (on leave back up)
      ...
      <div className={styles.container}>
        ...
        <div ref={rightRef} className={styles.right}>
          ...
          <div className={`${styles.badgeLine} ${styles.revealElement}`}>
            <span className={styles.subtitle}>SINCE 1982</span>
          ...
          <div className={`${styles.content} ${styles.revealElement}`}>
            <p>
              Based in the heart of <strong>Bhawani Peth, Pune</strong>, Vijay Agency 
              has redefined the wholesale landscape for four decades. We don't just supply sheets; 
              we provide the shield that protects your vision.
            </p>
            <p>
              From the industrial strength of <strong>Tata Durashine</strong> to the elegance of 
              <strong> Kiln-Fired Tiles</strong>, our curated range is built for those who refuse 
