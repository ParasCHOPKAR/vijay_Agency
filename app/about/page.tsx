            ...
            >
              ...
              <motion.div variants={fadeInUp} className={styles.textContent}>
                <p className={styles.leadText}>
                  Based in the heart of <strong>Bhawani Peth, Pune</strong>, Vijay Agency has been a pioneering force in the wholesale trading, retailing, and importing of premium roofing and decorative sheets.
                </p>
                <p>
